...
Article.prototype.insertRecord = function(callback) {
    $.post('/articles', {author: this.author, authorUrl: this.authorUrl, body: this.body, category: this.category, publishedOn: this.publishedOn, title: this.title})
        .then(data => {
            ...
            // This line will run the callback function if there is information stored in the callback variable. I think the callback function is not defined, so maybe this is a placeholder for something we will do later? 
